...
### Keeper Wallet (Auto-Paying Loans)

| Variable | Description |
|----------|-------------|
| `KEEPER_MNEMONIC` | 24-word mnemonic for keeper wallet |
| `CRON_SECRET` | Secret for cron job authorization |

The keeper wallet is used by `/api/cron/harvest` to auto-harvest rewards for self-paying loans.
Fund this wallet with ~10 SUI for gas. The keeper earns 0.1% tip from each harvest.
